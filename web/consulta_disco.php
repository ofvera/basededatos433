...
<?php 
	...
	$query_noticias_art_4 = "SELECT AI.id_a, n.titulo 
							 ...
							 WHERE N.id_n = AI.id_n AND N.fecha <= '$fecha_disco' + interval '2 month' AND N.fecha >= '$fecha_disco_sig';";

	//noticias asociadas banda
	$query_noticia_band_4 = "SELECT n.titulo 
							 FROM noticias N, bandas_involucrados BI 
							 WHERE N.id_n = BI.id_n AND BI.id_b = '$bid' AND N.fecha <= '$fecha_disco' + interval '2 month' AND N.fecha >= '$fecha_disco_sig';";
