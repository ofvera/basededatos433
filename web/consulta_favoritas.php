...
<?php
    ...
    while ($row_favorita33)	{
    	...
    	$query_conciertos4 = "SELECT B.nombre, C.nombre, C.lugar, C.fecha FROM concierto C, banda_invitada BI, concierto_banda CB, banda B WHERE ((C.id_c = BI.id_c AND BI.id_b = B.id_b) OR (C.id_c = CB.id_c AND CB.id_b = B.id_b)) AND B.id_b = '$row_favorita33[0]' ;"
